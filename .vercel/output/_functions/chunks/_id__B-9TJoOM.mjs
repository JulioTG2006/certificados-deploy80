...
import 'piccolore';
import { m as maybeRenderHead, r as renderTemplate, n as renderHead, o as renderComponent, p as renderSlot } from './entrypoint_DVbPku37.mjs';
...
Cerrar sesión
</button> </aside> ${renderScript($$result, "C:/PROYECTO5TO/certificados80/certificados/src/components/navigation/SidebarAdmin.astro?astro&type=script&index=0&lang.ts")}`;
}, "C:/PROYECTO5TO/certificados80/certificados/src/components/navigation/SidebarAdmin.astro", void 0);
...
}, "C:/PROYECTO5TO/certificados80/certificados/src/layouts/AdminLayout.astro", void 0);
...
Volver
</a> <p id="mensaje" class="font-semibold mt-4"></p> </div> </div> ${renderScript($$result2, "C:/PROYECTO5TO/certificados80/certificados/src/pages/admin/certificados/[id].astro?astro&type=script&index=0&lang.ts")} ` })}`;
}, "C:/PROYECTO5TO/certificados80/certificados/src/pages/admin/certificados/[id].astro", void 0);

const $$file = "C:/PROYECTO5TO/certificados80/certificados/src/pages/admin/certificados/[id].astro";
