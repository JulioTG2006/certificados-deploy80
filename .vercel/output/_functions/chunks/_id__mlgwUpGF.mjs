...
Enviar Solicitud
</button> <p id="mensaje" class="font-semibold"></p> </div> </div> ${renderScript($$result2, "C:/PROYECTO5TO/certificados80/certificados/src/pages/solicitudes/nueva/[id].astro?astro&type=script&index=0&lang.ts")} ` })}`;
}, "C:/PROYECTO5TO/certificados80/certificados/src/pages/solicitudes/nueva/[id].astro", void 0);

const $$file = "C:/PROYECTO5TO/certificados80/certificados/src/pages/solicitudes/nueva/[id].astro";
