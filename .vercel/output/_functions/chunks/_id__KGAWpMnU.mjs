...
Cargando...
</h1> </div> ${renderScript($$result2, "C:/PROYECTO5TO/certificados80/certificados/src/pages/solicitudes/[id].astro?astro&type=script&index=0&lang.ts")} ` })}`;
}, "C:/PROYECTO5TO/certificados80/certificados/src/pages/solicitudes/[id].astro", void 0);

const $$file = "C:/PROYECTO5TO/certificados80/certificados/src/pages/solicitudes/[id].astro";
